 ...
 */
  if ((FALSE) || (TRUE))
    {
      CHKexistSon (TERNARY_EXPR (arg_node), arg_node,
		   "mandatory son TERNARY_EXPR is NULL");
      if (TERNARY_EXPR (arg_node) != NULL)
	{
	  if (!((FALSE) || (isExpr (TERNARY_EXPR (arg_node)))))
	    {
	      CHKcorrectTypeInsertError (arg_node,
					 "TERNARY_EXPR hasnt the right type."
					 " It should be: " "Nodeset: Expr");
	    }
	}
    }
    ...
    {
      CHKnotExist (TERNARY_EXPR (arg_node), arg_node,
		   "attribute TERNARY_EXPR must be NULL");
    }

/*
 * Son check: TERNARY_FALSE 
 */
  if ((FALSE) || (TRUE))
    {
      CHKexistSon (TERNARY_FALSE (arg_node), arg_node,
		   "mandatory son TERNARY_FALSE is NULL");
      if (TERNARY_FALSE (arg_node) != NULL)
	{
	  if (!((FALSE) || (isExpr (TERNARY_FALSE (arg_node)))))
	    {
	      CHKcorrectTypeInsertError (arg_node,
					 "TERNARY_FALSE hasnt the right type."
					 " It should be: " "Nodeset: Expr");
	    }
	}
    }
    ...
    {
      CHKnotExist (TERNARY_FALSE (arg_node), arg_node,
		   "attribute TERNARY_FALSE must be NULL");
    }

/*
 * Son check: TERNARY_TRUE 
 */
  if ((FALSE) || (TRUE))
    {
      CHKexistSon (TERNARY_TRUE (arg_node), arg_node,
		   "mandatory son TERNARY_TRUE is NULL");
      if (TERNARY_TRUE (arg_node) != NULL)
	{
	  if (!((FALSE) || (isExpr (TERNARY_TRUE (arg_node)))))
	    {
	      CHKcorrectTypeInsertError (arg_node,
					 "TERNARY_TRUE hasnt the right type."
					 " It should be: " "Nodeset: Expr");
	    }
	}
    }
    ...
    {
      CHKnotExist (TERNARY_TRUE (arg_node), arg_node,
		   "attribute TERNARY_TRUE must be NULL");
    }
