...
node *
TBmakeModule (int Add, int Sub, int Div, int Mul, int Mod, node * Left,
	      node * Right)
{
  node *this;
  ...
  if ((MODULE_LEFT (this) != NULL)
      && (NODE_TYPE (MODULE_LEFT (this)) != N_binop)
      && (NODE_TYPE (MODULE_LEFT (this)) != N_var)
      && (NODE_TYPE (MODULE_LEFT (this)) != N_num)
      && (NODE_TYPE (MODULE_LEFT (this)) != N_float)
      && (NODE_TYPE (MODULE_LEFT (this)) != N_bool))
    {
      CTIwarn ("Field Left of node N_Module has non-allowed target node.");
    }
  if ((MODULE_RIGHT (this) != NULL)
      && (NODE_TYPE (MODULE_RIGHT (this)) != N_binop)
      && (NODE_TYPE (MODULE_RIGHT (this)) != N_var)
      && (NODE_TYPE (MODULE_RIGHT (this)) != N_num)
      && (NODE_TYPE (MODULE_RIGHT (this)) != N_float)
      && (NODE_TYPE (MODULE_RIGHT (this)) != N_bool))
    {
      CTIwarn ("Field Right of node N_Module has non-allowed target node.");
    }
#endif /* DBUG_OFF */
  DBUG_RETURN (this);
}
